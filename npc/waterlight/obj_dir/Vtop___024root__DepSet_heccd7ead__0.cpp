...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        if ((0U == (IData)(vlSelf->top__DOT__count))) {
            __Vdly__led = ((0xfffeU & ((IData)(vlSelf->led) 
                                       << 1U)) | (1U 
                                                  & ((IData)(vlSelf->led) 
                                                     >> 0xfU)));
        }
        __Vdly__top__DOT__count = ((0xffU > (IData)(vlSelf->top__DOT__count))
                                    ? (0xffU & ((IData)(1U) 
...
#endif
                    VL_FATAL_MT("/home/pz40/ysyx-workbench/npc/waterlight/vsrc/top.v", 1, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/pz40/ysyx-workbench/npc/waterlight/vsrc/top.v", 1, "", "NBA region did not converge.");
            }
